...
tags: ["ai", "architecture", "side-project"]
pinned: false
new: true
...
*Building a cross-border portfolio tracker for NRIs and expats managing assets across India, the EU, and the US. Stack: Next.js, Claude API, SQLite, Gmail OAuth.*
