...
browser  →  import('/assets/settings.abc123.js')
vercel   →  404 — that file doesn't exist anymore
react    →  Failed to fetch dynamically imported module
user     →  sees white flash, refreshes, everything works
```
